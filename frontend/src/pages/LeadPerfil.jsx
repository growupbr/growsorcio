            ...
            {lead.whatsapp && (
              <button
                ...
                onClick={() => {
                  ...
                  const interesse = lead.tipo_de_bem ? ` de ${lead.tipo_de_bem}` : '';
                  const msg = encodeURIComponent(`Olá ${lead.nome}, tudo bem? Vi seu interesse em consórcio${interesse} e quero te ajudar! 😊`);
                  abrirWhatsApp(`https://wa.me/${phone}?text=${msg}`);
                }}>
